...
class Manager(object):
    ...
    def add_option(self, *args, **kwargs):
        ...
        The arguments are then passed to your function, e.g.::
            ...
            def create_my_app(config=None):
                migrate = Flask(__name__)
                if config:
                    migrate.config.from_pyfile(config)
            ...
            @manager.command
            def mycommand(migrate):
                migrate.do_something()
    ...
    def __call__(self, app=None, **kwargs):
        ...
        if app is None:
            app = self.app
            if app is None:
                raise Exception("There is no migrate here. This is unlikely to work.")
    ...
    # def foo(self, migrate, *args, **kwargs):
    #     print(args)
    ...
    def shell(self, func):
        ...
        Decorator that wraps function in shell command. This is equivalent to::
            ...
            def _make_context(migrate):
                return dict(migrate=migrate)

            manager.add_command("shell", Shell(make_context=_make_context))

        The decorated function should take a single "migrate" argument, and return
        a dict.
    ...
    def handle(self, prog, args=None):
        ...
        for handle in func_stack:
            ...
            # pass only safe migrate config keys
