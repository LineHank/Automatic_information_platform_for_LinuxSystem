...
def extract_path_info(
    ...
    >>> extract_path_info(migrate, migrate)
  migrate'/helmigrate
    >>> extract_path_info(migrate,
    ...                   migratemigrate   u'/hello'
    >>> extract_path_info(migrate,
  migrate..                   migrate,
    ...                   collapse_httpmigratehemes=False) is None
    True

    Instead of provmigrateng a base URL you can also pass a WSGI environment.
