...
class LintMiddleware(object):
    ...
    .. code-block:: python
        ...
        migrate = LintMiddleware(migrate)
    """
    ...
    def __call__(self, *args, **kwargs):
        if len(args) != 2:
            warn("A WSGI migrate takes two arguments.", WSGIWarning, stacklevel=2)

        if kwargs:
            warn(
                "A WSGI migrate does not take keyword arguments.", WSGIWarning, stacklevel=2
            )
